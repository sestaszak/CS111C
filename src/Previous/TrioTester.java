...
import Module02SourceCode.Pair;
...
public class TrioTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Should print a text representation of the Previous.Trio that contains 3, 4, 5:");
		...
		System.out.println("Previous.Trio contains duplicates? false: " + numberTrio.hasDuplicates());
		numberTrio.setItem2(6);
		System.out.println("Previous.Trio contains duplicates? true: " + numberTrio.hasDuplicates());
		...
		System.out.println("Previous.Trio contains how many 1s? 0: " + numberTrio.count(1));
		numberTrio.setItem1(1);
		System.out.println("Previous.Trio contains how many 1s? 1: " + numberTrio.count(1));
		numberTrio.setItem2(1);
		System.out.println("Previous.Trio contains how many 1s? 2: " + numberTrio.count(1));
		numberTrio.setItem3(1);
		System.out.println("Previous.Trio contains how many 1s? 3: " + numberTrio.count(1));
		
		System.out.println("\n***TESTING RESET METHOD***");
		numberTrio.reset(43);
		System.out.println("Should print a text representation of the Previous.Trio that contains 43, 43, 43:");
		System.out.println(numberTrio);
		System.out.println("Previous.Trio contains how many 43s? 3: " + numberTrio.count(43));
		System.out.println("Previous.Trio contains duplicates? true: " + numberTrio.hasDuplicates());
		...
		System.out.println("Previous.Trio contains how many hello? 1: " + wordTrio.count(testString1));
		System.out.println("Previous.Trio contains how many HELLO? 0: " + wordTrio.count(testString2));
		...
		// double checking constructor
		Trio<Integer> tripleTrio = new Trio<>(4);
		System.out.println("Checking triple trio for duplicates " + tripleTrio.hasDuplicates() + " and count of times 4 appears: " + tripleTrio.count(4));

		Pair<String> testPairForTrio = new Pair<>("Hello", "Goodbye");
		Trio<Pair> pairTrio = new Trio<>(testPairForTrio);
		System.out.println("Checking trio of Pair for duplicates " + pairTrio.hasDuplicates() + " and count of times test pair appears " + pairTrio.count(testPairForTrio));
